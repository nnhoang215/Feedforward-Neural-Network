...
#include <iostream>
#include <random>
#include <algorithm> // what is this for? 
#include <cmath>
#include <time.h>
#include <numeric>
...
class Perceptron {
  public:
    ...
    double bias;
    // Constructor with default bias term of 1.0
...
class MultiLayerPerceptron {
  public:
    ...
    double bp(vector<double> x, vector<double> y); //what is this method? 

    vector<int> layers;
    double bias;
    double eta; // determines the learning speed, won't be discussed until later, ignore for now 
